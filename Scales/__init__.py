...
class Player(BasePlayer):
 ...
 # demographics
    ...
    subjectiveKnowledgePost = models.IntegerField( label= '  How knowledgeable do you feel about the effect of different behaviors on carbon footprints. That is, how much do you feel you know about how many CO<sub>2</sub> emissions are caused by differen actions?',
...
page_sequence = [ # BehaviorsFlying,  BehaviorsFood2,BehaviorsTransport, BehaviorsFood, BehaviorLaundry,
                 ClimateConcern, policyScales, Numeracy, NFC,  unit, End 
