...
class C(BaseConstants):
    ...
    FOOTPRINT_COMBINATIONS_TABLE_en = open('Nina_carbontask/FOOTPRINT_COMBINATIONS_TABLE_SAVE_en.json')
    ...
    FOOTPRINT_COMBINATIONS_IMAGES = [
        [ 'regional_image_1'	, 'recycling_image_2'	,'heating_image_1',	'diet_image_1',	'vacation_image_2',	'commute_image_2'	],
        [ 'regional_image_1',	'recycling_image_1',	'heating_image_1',	'diet_image_2',	'vacation_image_1',	'commute_image_2'	],
        [ 'regional_image_2',	'recycling_image_1',	'heating_image_1',	 'diet_image_1',	'vacation_image_2',	'commute_image_2'	],
        [ 'regional_image_2',	'recycling_image_2',	'heating_image_2',	'diet_image_1',	'vacation_image_1',	'commute_image_2'	],
        [ 'regional_image_2',	'recycling_image_2',	'heating_image_1'	, 'diet_image_1', 	'vacation_image_1',	'commute_image_1'	],
        [ 'regional_image_1',	'recycling_image_2',	'heating_image_2',	'diet_image_2',	'vacation_image_1',	'commute_image_2'	],
        [ 'regional_image_1',	'recycling_image_1',	'heating_image_2',	'diet_image_1',	'vacation_image_1',	'commute_image_1'	],
        [ 'regional_image_2',	'recycling_image_1',	'heating_image_1',	'diet_image_2',	'vacation_image_1',	'commute_image_1'	],
        [ 'regional_image_1',	'recycling_image_2',	'heating_image_1',	'diet_image_2',	'vacation_image_2',	'commute_image_1'	],
        [ 'regional_image_1',	'recycling_image_1',	'heating_image_2',	'diet_image_1',	'vacation_image_2',	'commute_image_1'	],
        [ 'regional_image_2',	'recycling_image_1',	'heating_image_2',	'diet_image_2',	'vacation_image_2',	'commute_image_2'	],
        [ 'regional_image_2',	'recycling_image_2',	'heating_image_2',	'diet_image_2',	'vacation_image_2',	'commute_image_1'	]
...
class Player(BasePlayer):
    rating0 = models.FloatField( label='How large or small do you think this persons footprint is?', mix=1.96, max=6.48)
    
    ratingSaving = models.FloatField( label='How large or small do you think this persons footprint is?', mix=0, max=3.38)


    attention_rating = models.FloatField( label='To demonstrate that you are reading the text attentively, please move the range slider all the way to the right (i.e. towards 5540).',  mix=0, max=3.38)
...
class task_page00(Page):
    ...
    def error_message(self, values):
        rating = str(values['ratingSaving'])
    ...
    def vars_for_template(player: Player):
        ...
        behavior_types= ["Food", "Recycling", "Heating", "Food", "Vacation", "Commute"]
...
class task_pageSaving(Page):

    # 0 is diet, 1 is electricity, 2 is recycling, 3 is regional food, 4 is commute, 5 vacation
    form_model = 'player'
    form_fields = ['ratingSaving']
    ...
    def vars_for_template(player: Player):
        ...
        current_footprint_table_shuffled = []
        current_footprint_table_images_shuffled = []
        behavior_types= ["Diet", "Recycling", "Heating", "Food", "Vacation", "Commute"]
        order_behavior_types = []
        for i in random_behavior_order:
            current_footprint_table_shuffled.append(my_vignette_table[i])
            current_footprint_table_images_shuffled.append(my_vignette_table_images[i])
...
class Attention(Page):
    ...
    def vars_for_template(player: Player):
        ...
        behavior_types = ["Diet", "Heating", "Move", "Food", "Commute", "Move"]
